...
public class UIAd_FuliAuto{
    public Transform Attr1;
    public Transform Attr2;
    public Transform Reward;
    public GameObject Btnclose;
    public void Init(Transform myTran, UIAd_Fuli model){
    ...
    private void InitGameObject(Transform myTran){
        Attr1 = myTran.Find("middle/attr1");
        Attr2 = myTran.Find("middle/attr2");
        Reward = myTran.Find("middle/reward");
        Btnclose = myTran.Find("middle/btnclose").gameObject;
    }
    void AddListen(UIAd_Fuli model){
    ...
    public void SetLanguage(Transform myTran){
		...
		trf= myTran.Find("middle/attr1/lb (1)");
		if(trf!=null){
			get=trf.GetComponent<Text>();
			get.text = get.text.ChangePrefabStr();
		}
		trf= myTran.Find("middle/attr1/lb");
		if(trf!=null){
			get=trf.GetComponent<Text>();
			get.text = get.text.ChangePrefabStr();
		}
		trf= myTran.Find("middle/attr1/btn/text");
		if(trf!=null){
			get=trf.GetComponent<Text>();
			get.text = get.text.ChangePrefabStr();
		}
		trf= myTran.Find("middle/attr1/time");
		if(trf!=null){
			get=trf.GetComponent<Text>();
			get.text = get.text.ChangePrefabStr();
		}
		trf= myTran.Find("middle/attr2/lb (1)");
		if(trf!=null){
			get=trf.GetComponent<Text>();
			get.text = get.text.ChangePrefabStr();
		}
		trf= myTran.Find("middle/attr2/lb");
		if(trf!=null){
			get=trf.GetComponent<Text>();
			get.text = get.text.ChangePrefabStr();
		}
		trf= myTran.Find("middle/attr2/btn/text");
		if(trf!=null){
			get=trf.GetComponent<Text>();
			get.text = get.text.ChangePrefabStr();
		}
		trf= myTran.Find("middle/attr2/time");
		if(trf!=null){
			get=trf.GetComponent<Text>();
			get.text = get.text.ChangePrefabStr();
		}
		...
		trf= myTran.Find("middle/Image/lb (1)");
		if(trf!=null){
			get=trf.GetComponent<Text>();
			get.text = get.text.ChangePrefabStr();
		}
